...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOE, LL_GPIO_PIN_3|LL_GPIO_PIN_13|LL_GPIO_PIN_14|LL_GPIO_PIN_15);
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_3|LL_GPIO_PIN_13|LL_GPIO_PIN_14|LL_GPIO_PIN_15;
